...
*/
	...
	thelper.talkPre = '../Helper/AnimatedCat/CatTalk';
	thelper.talkPost = '.png';
	thelper.waveFrames = 28;
	thelper.wavePre = '../Helper/AnimatedCat/CatLookAtMe';
	...
	// while post should be the file path after the numbers in the images, such as ".png".
		thelper.talkFrames = frames;
		thelper.talkPre = pre;
		thelper.talkPost = post;
	...
	// while post should be the file path after the numbers in the images, such as ".png".
		thelper.waveFrames = frames;
		thelper.wavePre = pre;
		thelper.wavePost = post;
	...
	// Changes the helper's image based on which animation is playing, if any.
		...
		// Talking animation is playing.
			...
			// Only animate if there is an animation defined.
				this.setImage(this.talkPre + this.curFrame + this.talkPost);
				this.curFrame ++;
		...
		// Waving animation is playing.
			...
			// Only animate if there is an animation defined.
				this.setImage(this.wavePre + this.curFrame + this.talkPost);
				this.curFrame ++;
