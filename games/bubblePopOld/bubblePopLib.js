...
// starts to customize each level. The game is started by calling init().
	...
	this.init = function() {
		...
		this.questionHolder = new QuestionHolder(this.game, this.questionImage, this.helperWidth, this.helperHeight, 10, this.gameHeight - (this.gameHeight * (9/50)));
	...
	this.makeAnswers = function() {
		...
		for(var i=0;i<3;i++){
			this.answerBubbles.push(new Bubble(this.game, this.bubbleWidth, this.bubbleHeight, this.bubbleFallSpeed, this.baseImage, 8+i, this.fileExt));
